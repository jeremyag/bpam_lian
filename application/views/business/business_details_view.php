...
<div class="text-right">
    <button type="button" data-id="<?=$bd->id?>" data-business_id="<?=$business->id?>" data-gaction="edit_business_details" data-base_url="<?=base_url().add_index()?>" class="btn btn-secondary gModal-btn">Edit</button>
</div>
<br>
<table class="table">
    <tbody>
